...
def argsparser():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=("Directory include:'models.pdiparams', 'models.pdmodel', "
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="If the models is produced by TRT offline quantitative "
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="max batch_size for reid models inference.")
    parser.add_argument(
        '--use_dark',
        type=ast.literal_eval,
        default=True,
