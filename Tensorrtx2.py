...
class TRTInference:
    def __init__(self, trt_engine_path, batch_size):
    ...
    def infer(self, img):
        ...
        self.cfx.pop()
        return host_outputs[0].reshape(25200, -1), time.time() - start
        # return [host_outputs[0].reshape(1,-1) for out in host_outputs]
