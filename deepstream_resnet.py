...
class Deep(QMainWindow):
    ...
    def __init__(self, lchannel):
        self.lchannel = lchannel
        self.run()


    def display_frame(self,frameImage):

        self.lchannel.setPixmap(self.img2pyqt(frameImage,self.lchannel))
    ...
    def run(self):
        ...
        args = ['deepstream_imagedata-multistream.py','rtsp://admin:ai123456@192.168.0.51', 'frames22']
